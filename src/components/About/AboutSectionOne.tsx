              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Multi-chain ingestion" />
                    <List text="Kafka streaming" />
                    <List text="Real-time indexing" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Spark / Flink compute" />
                    <List text="ClickHouse analytics" />
                    <List text="Developer APIs" />
                  </div>
                </div>
              </div>
            </div>
