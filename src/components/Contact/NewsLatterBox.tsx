    ...
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-md bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <div>
        ...
        <input
          type="submit"
          value="Subscribe"
          className="bg-primary shadow-submit hover:bg-primary/90 dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-md px-9 py-4 text-base font-medium text-white duration-300"
        />
        ...
        <span className="absolute top-7 left-2">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#1da1f2" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
