  ...
  return (
    <>
      <a
        ...
        className="bg-gray-light text-body-color hover:bg-primary dark:bg-gray-dark dark:hover:bg-primary mb-3 inline-flex h-9 w-9 items-center justify-center rounded-md duration-300 hover:text-white sm:ml-3"
      >
        <svg
          width="16"
          height="16"
      ...
      <a
        href="#0"
        aria-label="social-share"
        className="bg-gray-light text-body-color hover:bg-primary dark:bg-gray-dark dark:hover:bg-primary mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-md duration-300 hover:text-white"
      >
        <svg
          width="18"
          height="18"
